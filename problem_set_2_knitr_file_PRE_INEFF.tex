           ...
           \hlkwa{while} \hlstd{((bad_neighbors} \hlopt{+} \hlstd{good_neighbors)} \hlopt{<} \hlstd{(LocationTable[individual,}\hlnum{6}\hlstd{]))\{}
             ...
             \hlkwa{if} \hlstd{(a_neighbors_race} \hlopt{!=} \hlstd{own_race)\{}
               ...
               \hlcom{## increase number of bad neighbors}
                 ...
                 \hlkwa{if} \hlstd{(bad_neighbors} \hlopt{>} \hlstd{(LocationTable[individual,}\hlnum{7}\hlstd{]))\{}
                 \hlcom{##If the number of bad neighbors exceeds threshold...}
                   ...
                   \hlstd{LocationTable[individual,}\hlnum{3}\hlstd{]} \hlkwb{<-} \hlstd{new_x}
                   \hlstd{LocationTable[individual,}\hlnum{4}\hlstd{]} \hlkwb{<-} \hlstd{new_y}
                   \hlstd{LoopUnhappyLocationTable[individual,}\hlnum{3}\hlstd{]} \hlkwb{<-} \hlstd{new_x}
                   \hlstd{LoopUnhappyLocationTable[individual,}\hlnum{4}\hlstd{]} \hlkwb{<-} \hlstd{new_y}
